...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('game_platform')->insert([
            ['game_id' => 1, 'platform_id' => 1], // Battlefield 2042 on PS5
            ['game_id' => 1, 'platform_id' => 2], // Battlefield 2042 on Xbox
            ['game_id' => 2, 'platform_id' => 1], // Assassin's Creed on PS5
            ['game_id' => 2, 'platform_id' => 3], // Assassin's Creed on Switch
            ['game_id' => 3, 'platform_id' => 1], // Zelda on PS5 (hypothetical)
            ['game_id' => 3, 'platform_id' => 3], // Zelda on Switch
        ]);

        // Game-Genre relationships
        DB::table('game_genre')->insert([
            ['game_id' => 1, 'genre_id' => 1], // Battlefield 2042 - Action
            ['game_id' => 2, 'genre_id' => 1], // Assassin's Creed - Action
            ['game_id' => 2, 'genre_id' => 2], // Assassin's Creed - RPG
            ['game_id' => 3, 'genre_id' => 1], // Zelda - Action
            ['game_id' => 3, 'genre_id' => 2], // Zelda - RPG
        ]);
